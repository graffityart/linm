...
export const metadata = {
  ...
  openGraph:{type:'website',locale:'ko_KR',siteName:'몽땅 다이아',url:'/',title:'린M 할인 충전 | 몽땅 다이아',description:'린M 충전·할인과 게임정보를 한곳에서 확인하세요.'},
  twitter:{card:'summary',title:'린M 할인 충전 | 몽땅 다이아',description:'린M 충전·할인과 게임정보를 한곳에서 확인하세요.'}
};
