...
<section className="subhero container"><div><span className="eyebrow">린M 공략</span><h1>초보·육성·장비·신격을 검색 목적별로 분리</h1><p>한 페이지에 모든 키워드를 반복하지 않고, 실제 게임 자료가 있는 범위에서 각 공략 주제를 독립적으로 관리합니다.</p></div><SiteImage src="/images/guide/guide-hero.webp" alt="린M 공략 종합 대표 이미지" priority/></section>
