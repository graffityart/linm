...
<section className="subhero container"><div><span className="eyebrow">린M 다이아</span><h1>린M 다이아·귀속 다이아·린M 코인은 어떻게 다를까?</h1><p>이름이 비슷한 재화를 한데 섞지 않고, 실제 게임 화면과 공식 안내에서 확인된 범위만 구분해 정리합니다.</p></div><SiteImage src="/images/charge/diamond-hero.webp" alt="린M 다이아와 귀속 다이아 대표 이미지" priority/></section>
...
<section className="section container split-section"><SiteImage className="content-image-slot" src="/images/charge/diamond-content.webp" alt="린M 게임 재화 안내 이미지"/><div><span className="eyebrow">관련 정보</span><h2>가격 정보와 충전 방법은 별도 페이지에서</h2><p>이 페이지는 재화의 구분에 집중하고, 충전 가격과 구매 문의는 충전 페이지에서 분리해 안내합니다.</p><Link className="text-link" href="/rinm/charge">린M 충전 가격 보기 →</Link><br/><Link className="text-link" href="/rinm/guide/charge">린M 충전 방법 보기 →</Link></div></section>
</>}
